#include <bits/stdc++.h>
using namespace std;
long long int get_num(string a, int j)
{
    while (j > 0 && a[j - 1] >= '0' && a[j - 1] <= '9')
    {
        j--;
    }
    long long int num = 0;
...
void check(string a, int j, vector<int> &v)
{
    if (a[j] >= '0' && a[j] <= '9')
    {
        v.push_back(get_num(a, j));
    }
    else
    {
        if (j > 0 && a[j - 1] >= '0' && a[j - 1] <= '9')
        {
            v.push_back(get_num(a, j - 1));
        }
        if (j + 1 < a.size() && a[j + 1] >= '0' && a[j + 1] <= '9')
        {
            v.push_back(get_num(a, j + 1));
        }
    }
}
long long int special(string a, string b, string c, int j)
{
    vector<int> v;
    if (a.size())
    {
...
long long int solve(vector<string> &v)
{
    ...
    for (int i = 0; i < n; i++)
    {
        for (int j = 0; j < m; j++)
        {
            if (v[i][j] == '*')
            {
                ans += special(((i > 0) ? v[i - 1] : ""), v[i], ((i < n - 1) ? v[i + 1] : ""), j);
            }
        }
    }
    return ans;
...
int main()
{
    vector<string> input = {"....573.613.........965............691......892..948.......964........439.375..................320......273...........352.284...............",
                            ".......*.............*.....814...............$....*........../..94......*....=.............103............/..882*...........+...............",
